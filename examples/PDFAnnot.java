...
public final class PDFAnnot
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try
        {
            ...
            //PDTrueTypeFont font = PDTrueTypeFont.load(document, file, WinAnsiEncoding.INSTANCE);
            PDType0Font font = PDType0Font.load(document, file);
            //PDTrueTypeFont font = PDTrueTypeFont(document, new TTFParser().parse(file), WinAnsiEncoding.INSTANCE, true);
